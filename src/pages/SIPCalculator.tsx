...
import { Save, RotateCcw, TrendingUp, Calculator, TrendingUp as TrendingUpIcon, Info } from 'lucide-react';
            ...
            <Dialog open={infoDialogOpen} onOpenChange={setInfoDialogOpen}>
              ...
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">What is SIP?</h3>
                    <p className="text-muted-foreground">
                      Systematic Investment Plan (SIP) is an investment strategy where you invest a fixed amount regularly (usually monthly) in mutual funds or other investment instruments. SIP allows you to invest small amounts consistently over time, helping you build wealth through the power of compounding and rupee cost averaging.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li><strong>Rupee Cost Averaging:</strong> Buying more units when prices are low and fewer when prices are high</li>
                      <li><strong>Discipline:</strong> Encourages regular saving and investing habits</li>
                      <li><strong>Affordability:</strong> Start with small amounts (as low as ₹500 per month)</li>
                      <li><strong>Power of Compounding:</strong> Earn returns on your returns over time</li>
                      <li><strong>Flexibility:</strong> Increase, decrease, pause, or stop SIP anytime</li>
                      <li><strong>Long-term Wealth Creation:</strong> Ideal for achieving long-term financial goals</li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Step-Up SIP</h3>
                    <p className="text-muted-foreground">
                      Step-Up SIP automatically increases your investment amount every year by a fixed percentage. This helps you keep pace with salary increments and inflation, accelerating your wealth creation. For example, if you start with ₹10,000/month and set a 10% step-up, your investment will be ₹11,000/month in year 2, ₹12,100/month in year 3, and so on.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-foreground mb-2">SIP Calculation</h3>
                    <p className="text-muted-foreground mb-2">
                      SIP uses the future value of annuity formula to calculate returns:
                    </p>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li>SIP does not guarantee returns - market-linked investments are subject to market risks</li>
                      <li>Longer investment periods generally provide better results due to compounding</li>
                      <li>Choose SIP based on your risk appetite, financial goals, and investment horizon</li>
                      <li>Review and rebalance your portfolio periodically</li>
                      <li>Consider inflation when setting expected returns for real returns</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      The SIP calculator helps you estimate the future value of your systematic investments. You can calculate regular SIP, step-up SIP, and inflation-adjusted returns to understand both nominal and real returns. This helps you plan your investments better and set realistic financial goals.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-muted-foreground">
                      <div className="bg-blue-50 dark:bg-blue-950 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
                        <p className="font-semibold text-blue-900 dark:text-blue-100 mb-1">Example 1: Basic Monthly SIP</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> Invest ₹10,000/month for 10 years at 12% annual return<br />
                          <strong>Total Invested:</strong> ₹10,000 × 12 × 10 = ₹12,00,000<br />
                          <strong>Calculation:</strong> Using compound interest formula with monthly contributions<br />
                          <strong>Maturity Value:</strong> Approximately ₹23,00,000<br />
                          <strong>Returns Earned:</strong> ₹11,00,000 (92% of investment)<br />
                          <strong>Benefit:</strong> Disciplined investing creates wealth over time
                        </p>
                      </div>

                      <div className="bg-green-50 dark:bg-green-950 p-3 rounded-lg border border-green-200 dark:border-green-800">
                        <p className="font-semibold text-green-900 dark:text-green-100 mb-1">Example 2: Step-Up SIP Benefits</p>
                        <p className="text-sm">
                          <strong>Regular SIP:</strong> ₹10,000/month for 20 years → ₹99,00,000 corpus<br />
                          <strong>Step-Up SIP:</strong> Start ₹10,000, increase 10% yearly for 20 years → ₹1,45,00,000 corpus<br />
                          <strong>Extra Investment:</strong> Step-up invests ₹34,00,000 more<br />
                          <strong>Extra Returns:</strong> ₹46,00,000 more corpus (₹12 lakh extra gains)<br />
                          <strong>Benefit:</strong> Step-up SIP accelerates wealth creation with salary increments
                        </p>
                      </div>

                      <div className="bg-purple-50 dark:bg-purple-950 p-3 rounded-lg border border-purple-200 dark:border-purple-800">
                        <p className="font-semibold text-purple-900 dark:text-purple-100 mb-1">Example 3: Long-Term Wealth Creation</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> ₹5,000/month SIP for 30 years at 12% return<br />
                          <strong>Total Invested:</strong> ₹18,00,000<br />
                          <strong>Final Corpus:</strong> ₹1,75,00,000 (₹1.75 crores)<br />
                          <strong>Returns:</strong> ₹1,57,00,000 (8.7x the investment)<br />
                          <strong>Power of Compounding:</strong> Last 10 years contributed ₹60 lakhs to final corpus<br />
                          <strong>Lesson:</strong> Time is the most powerful factor in wealth creation
                        </p>
                      </div>

                      <div className="bg-amber-50 dark:bg-amber-950 p-3 rounded-lg border border-amber-200 dark:border-amber-800">
                        <p className="font-semibold text-amber-900 dark:text-amber-100 mb-1">Example 4: Inflation-Adjusted Returns</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> ₹20,000/month SIP, 12% return, 6% inflation, 20 years<br />
                          <strong>Nominal Corpus:</strong> ₹1,98,00,000<br />
                          <strong>Real Value:</strong> ₹61,00,000 (inflation-adjusted purchasing power)<br />
                          <strong>Insight:</strong> ₹1.98 crores sounds huge but buys what ₹61 lakhs would today<br />
                          <strong>Planning:</strong> Factor inflation to set realistic retirement goals<br />
                          <strong>Solution:</strong> Increase SIP amount periodically to beat inflation
                        </p>
                      </div>
                      ...
                      <div className="bg-red-50 dark:bg-red-950 p-3 rounded-lg border border-red-200 dark:border-red-800">
                        ...
                        <p className="text-sm">
                          <strong>Amit's Strategy:</strong> Started ₹15,000/month SIP at age 30, step-up 10% yearly, target ₹2 crores by age 60<br />
                          <strong>Year 1-10:</strong> Invested ₹27,00,000, value grew to ₹35,00,000<br />
                          <strong>Year 11-20:</strong> SIP increased to ₹39,000/month, corpus reached ₹1,15,00,000<br />
                          <strong>Year 21-30:</strong> SIP at ₹1,00,000/month, final corpus = ₹2,45,00,000<br />
                          <strong>Success:</strong> Exceeded target by ₹45 lakhs through step-up strategy<br />
                          <strong>Key:</strong> Started early, stayed disciplined, increased investments with income growth
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950 dark:to-teal-950 p-3 rounded-lg border border-emerald-200 dark:border-emerald-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-emerald-800 dark:text-emerald-200">
                      <li>Start SIP as early as possible - even ₹5,000/month can build crores over 30 years</li>
                      <li>Enable step-up SIP to match salary increments - accelerates wealth creation</li>
                      <li>Don't stop SIP during market downturns - you buy more units at lower prices</li>
                      <li>Review and rebalance portfolio annually based on risk appetite and goals</li>
                      <li>Consider inflation when setting return expectations - 12% nominal = 6% real (with 6% inflation)</li>
                    </ul>
                  </div>
                </div>
              </DialogContent>
