            ...
            <Dialog open={infoDialogOpen} onOpenChange={setInfoDialogOpen}>
              ...
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">What is SWP?</h3>
                    <p className="text-muted-foreground">
                      Systematic Withdrawal Plan (SWP) is an investment strategy where you withdraw a fixed amount regularly (usually monthly) from your investment corpus. SWP helps you create a regular income stream from your investments, ideal for retirees or those seeking regular cash flow.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Benefits of SWP</h3>
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li><strong>Regular Income:</strong> Provides steady monthly cash flow</li>
                      <li><strong>Tax Efficiency:</strong> Only capital gains are taxable, not the principal</li>
                      <li><strong>Flexibility:</strong> Adjust withdrawal amount or stop anytime</li>
                      <li><strong>Remaining Corpus Grows:</strong> Unwithdrawn amount continues to earn returns</li>
                      <li><strong>Discipline:</strong> Helps manage expenses and withdrawals systematically</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">How SWP Works</h3>
                    <p className="text-muted-foreground">
                      In SWP, you invest a lump sum amount and then withdraw a fixed amount every month. The remaining corpus continues to grow at the expected return rate. The SWP duration depends on your withdrawal amount, expected returns, and initial investment. Higher withdrawal amounts or lower returns reduce the duration.
                    </p>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      ...
                      <li>Withdrawal amount should be sustainable based on corpus and expected returns</li>
                      <li>Higher withdrawal rates deplete corpus faster</li>
                      <li>Consider inflation when setting withdrawal amounts</li>
                      <li>Tax implications depend on holding period (short-term vs long-term capital gains)</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Calculator Features</h3>
                    <p className="text-muted-foreground">
                      The SWP calculator helps you estimate how long your investment corpus will last with regular withdrawals. Enter your investment amount, monthly withdrawal, expected return, and optionally inflation rate to see the projected corpus duration and remaining balance over time.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-muted-foreground">
                      <div className="bg-blue-50 dark:bg-blue-950 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
                        <p className="font-semibold text-blue-900 dark:text-blue-100 mb-1">Example 1: Monthly Withdrawal Scenario</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> Corpus = ₹50,00,000, Withdraw ₹50,000/month, 10% annual return<br />
                          <strong>Calculation:</strong> Withdrawal rate = 12% per year (₹6L from ₹50L)<br />
                          <strong>Result:</strong> Corpus lasts approximately 11-12 years<br />
                          <strong>Withdrawal Strategy:</strong> Withdraw 1% of corpus monthly<br />
                          <strong>Tip:</strong> Keep withdrawal rate below return rate to preserve corpus<br />
                          <strong>Safety:</strong> At 8% withdrawal rate, corpus can last 15+ years
                        </p>
                      </div>

                      <div className="bg-green-50 dark:bg-green-950 p-3 rounded-lg border border-green-200 dark:border-green-800">
                        <p className="font-semibold text-green-900 dark:text-green-100 mb-1">Example 2: Retirement Income Planning</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> Retire at 60, need ₹80,000/month, corpus = ₹2 crores, 12% return<br />
                          <strong>Withdrawal Rate:</strong> 4.8% per year (₹9.6L from ₹2Cr)<br />
                          <strong>Duration:</strong> Corpus can sustain for 25+ years (till age 85+)<br />
                          <strong>Corpus Growth:</strong> Even with withdrawals, corpus grows for first 10-15 years<br />
                          <strong>Safety:</strong> Conservative 4% rule ensures corpus lasts retirement period<br />
                          <strong>Planning:</strong> Build larger corpus if you want higher monthly income
                        </p>
                      </div>

                      <div className="bg-purple-50 dark:bg-purple-950 p-3 rounded-lg border border-purple-200 dark:border-purple-800">
                        <p className="font-semibold text-purple-900 dark:text-purple-100 mb-1">Example 3: Corpus Duration Calculation</p>
                        <p className="text-sm">
                          <strong>Situation A:</strong> ₹1 crore, ₹1,00,000/month withdrawal, 10% return → Lasts 9 years<br />
                          <strong>Situation B:</strong> ₹1 crore, ₹50,000/month withdrawal, 10% return → Lasts 20 years<br />
                          <strong>Insight:</strong> Halving withdrawal doubles corpus duration<br />
                          <strong>Reason:</strong> Lower withdrawal allows corpus to grow while being used<br />
                          <strong>Strategy:</strong> Withdraw conservatively to make corpus last longer<br />
                          <strong>Rule of Thumb:</strong> 4% annual withdrawal (0.33% monthly) is safe for 30+ years
                        </p>
                      </div>

                      <div className="bg-amber-50 dark:bg-amber-950 p-3 rounded-lg border border-amber-200 dark:border-amber-800">
                        <p className="font-semibold text-amber-900 dark:text-amber-100 mb-1">Example 4: Inflation-Adjusted Withdrawals</p>
                        <p className="text-sm">
                          <strong>Situation:</strong> ₹1 crore corpus, ₹60,000/month, 6% inflation, 12% return<br />
                          <strong>Year 1:</strong> Withdraw ₹60,000/month, corpus grows to ₹1.03 crores<br />
                          <strong>Year 5:</strong> Withdraw ₹80,000/month (inflation-adjusted), corpus = ₹95 lakhs<br />
                          <strong>Year 10:</strong> Withdraw ₹1,07,000/month, corpus depleting faster<br />
                          <strong>Result:</strong> Corpus lasts 14 years (vs 18 years without inflation)<br />
                          <strong>Planning:</strong> Factor inflation - ₹60,000 today = ₹1.07 lakhs in 10 years
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950 dark:to-teal-950 p-3 rounded-lg border border-emerald-200 dark:border-emerald-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-emerald-800 dark:text-emerald-200">
                      <li>Follow 4% rule: Withdraw 4% of corpus annually for 30+ year sustainability</li>
                      <li>Start with lower withdrawal rate if corpus is new - let it grow first</li>
                      <li>Consider inflation when planning - monthly needs increase over time</li>
                      <li>Keep some corpus in liquid funds for immediate needs - avoid forced selling</li>
                      <li>Review withdrawal rate annually based on returns and remaining corpus</li>
                    </ul>
                  </div>
                </div>
              </DialogContent>
